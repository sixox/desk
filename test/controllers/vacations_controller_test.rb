...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference("Vacation.count") do
      post vacations_url, params: { vacation: { comment: @vacation.comment, confirm: @vacation.confirm, details: @vacation.details, end_at: @vacation.end_at, start_at: @vacation.start_at, status: @vacation.status, type: @vacation.type, user_id: @vacation.user_id } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { comment: @vacation.comment, confirm: @vacation.confirm, details: @vacation.details, end_at: @vacation.end_at, start_at: @vacation.start_at, status: @vacation.status, type: @vacation.type, user_id: @vacation.user_id } }
