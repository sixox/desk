class Booking < ApplicationRecord
  ...
  LINE = ['ADMIRAL', 'RASHA', 'BLUE', 'AVASH', 'DARYA BAAR', 'TUSHEHBAR', 'ARYA LAND', 'NAVBAN DARYA', 'CORVET', 'KUSHAN DARYA', 'ARTEMIS DARYA', 'NOVEL', 'ECON', 'RADIAN DARYA', 'KALADARAN', 'HORMOZ MARIN', 'HDS', 'ASL', 'TIAM DARYA', 'DATAM SEA ARVAND', 'MARITIME MAVEN MANAGEMENT', 'ESPAD DARYA', 'ARTA']
  FORWARDER = ['ADMIRAL', 'RASHA', 'BLUE', 'AVASH', 'DARYA BAAR', 'TUSHEHBAR', 'ARYA LAND', 'NAVBAN DARYA', 'CORVET', 'KUSHAN DARYA', 'ARTEMIS DARYA', 'NOVEL', 'ECON', 'RADIAN DARYA', 'HORMOZ MARIN', 'KALADARAN', 'TIAM DARYA', 'DATAM SEA ARVAND', 'MARITIME MAVEN MANAGEMENT', 'ESPAD DARYA', 'ARTA']
