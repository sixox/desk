class Booking < ApplicationRecord
  ...
  LINE = ['RASHA', 'BLUE', 'AVASH', 'DARYA BAAR', 'TUSHEHBAR', 'ARYA LAND', 'NAVBAN DARYA', 'CORVET', 'KUSHAN DARYA', 'ARTEMIS DARYA', 'NOVEL', 'ECON', 'RADIAN DARYA', 'KALADARAN', 'HORMOZ MARIN', 'HDS', 'ASL']
  FORWARDER = ['RASHA', 'BLUE', 'AVASH', 'DARYA BAAR', 'TUSHEHBAR', 'ARYA LAND', 'NAVBAN DARYA', 'CORVET', 'KUSHAN DARYA', 'ARTEMIS DARYA', 'NOVEL', 'ECON', 'RADIAN DARYA', 'HORMOZ MARIN', 'KALADARAN']
